...
public class WSN {
    ...
    private static final int LENGTH = 1000; // number of sensors
    private static final int INITIAL_OA_NUMBER = 100; // fixed number of OAs
    private static final int POPULATION_SIZE = 1000; // no of random solutions in the begining
